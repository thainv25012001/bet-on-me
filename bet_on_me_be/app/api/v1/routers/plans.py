...
async def list_plans(
    ...
    items, total = await service.list_plans(goal_id, current_user, page, page_size)
    return paginated_response([PlanOut.model_validate(p) for p in items], total, page, page_size)
